...
export default function Match({ data }) {
  ...
  return (
    <div className="flex flex-col item-center gap-2 w-full rounded-md border border-gray-200 p-1 md:p-2 px-1 md:px-4">
      <div className="flex gap-2 md:gap-6">
        ...
        <div className="flex flex-1 flex-col justify-between gap-1 px-2 md:px-6 border-x border-x-gray-100">
          <div className="flex items-center gap-2 md:gap-4 h-7 md:h-8">
            ...
            <div className="flex gap-1 md:gap-2 px-1 md:px-2 py-1 rounded-full bg-gray-100">
              {
                homeDots.map((item, i) => (
                  <div className={clsx(
